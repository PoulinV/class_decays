...
M.set({
    'omega_cdm': 0.000001,
#    'omega_ini_dcdm2': 0.11985,
    'Omega_ini_dcdm2': 0.2666,
...
#    'ncdm_fluid_trigger_tau_over_tau_k': 25,
    'Number of momentum bins perturbs': '50,10000',
...
plt.fill_between(k_range_desy1, -1.0,0.5, color='lightgray' )
