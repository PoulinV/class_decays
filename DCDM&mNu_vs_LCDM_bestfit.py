...
print("sigma8 for LCDM with total neutrino mass M_nu=%.2f eV is %f" %(M_ncdm,derived['sigma8']) )
print("and Omega_m is %f"%derived['Omega_m'])
print("and z_eq is %f"%derived['z_eq'])
...
ax_2.fill_between(l_cosmic_variance, -0.15,0.15, color='lightgray' )
